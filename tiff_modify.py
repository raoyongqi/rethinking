...
tif_files = [
    'data/cropped_predicted_rf_126.tif',
    'data/cropped_predicted_rf_245.tif',
    'data/cropped_predicted_rf_370.tif',
    'data/cropped_predicted_rf_585.tif'
]
...
output_file = os.path.join(output_dir, 'multiple_scenarios.png')

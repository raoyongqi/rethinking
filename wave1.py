...
data = pd.read_excel('data/merged_data1.xlsx')  # 替换为你的CSV文件路径
...
input_x = tf.keras.layers.Input(shape=(67,))
x = tf.keras.layers.Reshape(target_shape=[67, 1])(input_x)
num_blocks = 2
dilation_rates = (1, 2) 
